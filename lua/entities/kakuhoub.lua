...
function ENT:Draw()
	...
	local TextWidth = surface.GetTextSize("Kakuhou - Treated")
	
	Ang:RotateAroundAxis(Ang:Forward(), 90)
	Ang:RotateAroundAxis(Ang:Right(), CurTime() * -90)

	cam.Start3D2D(Pos, Ang, 0.11)
		draw.WordBox(2, -TextWidth*0.5, -60, "Kakuhou - Treated", "Trebuchet18", Color(0, 0, 0, 200), Color(255,255,255,255))
	cam.End3D2D()
end
/* Copyright (C) Remigius - All Rights Reserved
 * Unauthorized copying of this file, via any medium is strictly prohibited
