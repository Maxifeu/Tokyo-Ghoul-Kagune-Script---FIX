...
local tr = util.TraceLine( {
		...
		local dmg = math.random(KOUKAKUPRMATK1 * ply:GetNWInt("QuinxCells", 1.25),KOUKAKUPRMATK2 * ply:GetNWInt("QuinxCells", 1.25) )
...
function SWEP:SecondaryAttack()
	...
	self:GetOwner():SetNWInt("QuinxKoukakuShield", CurTime() + 0.25 )
end
